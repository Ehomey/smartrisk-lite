...
$filesDir = $baseDir
$toolsDir = Join-Path $filesDir "tools"
...
Write-Host "Moving backend directory..."
Move-Item -Path $backendDir -Destination $filesDir -Force
Write-Host "Backend directory moved successfully."
